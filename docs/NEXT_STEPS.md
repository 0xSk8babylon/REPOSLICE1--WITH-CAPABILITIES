...
- The current Design Advisor UI now reflects that reasoning spine through clearer workspace sections plus compact architecture/reasoning and pathway-comparison visuals, so the next change can deepen solar realism without first reworking page structure again.
