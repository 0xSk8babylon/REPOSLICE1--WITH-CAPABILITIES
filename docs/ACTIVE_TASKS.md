...
6. Extend the current inspectable battery, solar, roof-readiness, panel/service, and backup-load-selection slices into broader profile-backed recommendation behavior before inverter sizing.
