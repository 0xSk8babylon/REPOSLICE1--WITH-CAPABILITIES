...
6. Extend the current inspectable battery, solar, roof-readiness, current-home-energy-architecture, panel/service, backup-load-selection, profile-architecture-fit, inverter/system-architecture, structured-reasoning-graph, planning-state snapshot, and workspace/diagram/comparison-oriented advisor UI slices while keeping the newly stabilized trust wording intact.
