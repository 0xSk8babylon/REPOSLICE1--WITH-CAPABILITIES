...
- Phase 7: Shared Compatibility & Install Path View - complete in the working tree as `GET /api/twin-planning-context/homes/{home_id}/views/shared-compatibility`.
