...
- Phase 10: Proposal Option Sets - implemented in the working tree as `GET /api/proposal-option-sets/homes/{home_id}`.

## What Changed Last

- Phase 10 Proposal Option Sets was implemented in the working tree and is not yet staged or committed.
