...
class AuditEvent(Base, TimestampMixin):
    ...
    actor_identity_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    auth_source: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    account_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    object_type: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    object_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    route_template: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    source_surface: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    ...
    provenance_refs: Mapped[Optional[list]] = mapped_column(JSON, nullable=True)
